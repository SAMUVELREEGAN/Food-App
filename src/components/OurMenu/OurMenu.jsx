...
const categories = ['Veg', 'NonVeg', 'Drinks'] 

const OurMenu = () => {

    const [activeCategory, setActiveCategory] = useState( categories[0] );
    
    const displayedItems = (dummyMenuData[activeCategory] || []).slice(0, 12);
                        ...
                        return(
                            ...
                            style={{ '--index': i}}>
                                <div className='relative h-48 sm:h-56 md:h-60 flex items-center justify-center bg-black/10'>
                                    ...
                                    className='max-h-full max-w-full object-contain transition-all duration-70'/>
                                </div>
                                     ...
                                     <div className='mt-auto flex items-center gap-4 justify-between'>
                                        ...
                                        <div className='flex items-center gap-2'>
                                            {quantity > 0 ? (
                                                ...
                                                hover:scale-105 hover:shadow-lg hover:shadow-amber-900/20 relative overflow-hidden
