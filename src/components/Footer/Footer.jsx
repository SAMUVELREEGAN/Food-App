            ...
            <form onSubmit={handleSubmit} className="relative mt-4 group">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  text-white px-4 py-2 rounded-full flex items-center gap-1.5 shadow-lg 
                  hover:shadow-amber-400/30 transition-all duration-500 overflow-hidden"
                >
                  <span className="font-bold text-sm tracking-wide group-hover:-translate-x-1 transition-transform">
                    Join Now
                  </span>
                  <BiChevronRight className="text-xl group-hover:animate-spin transition-transform" />
                  <span className="absolute inset-0 -translate-x-full bg-gradient-to-br 
                  from-transparent via-amber-50/30 to-transparent 
                ...
                {socialIcons.map(
                  ({ icon: Icon, link, color, label }, index) => (
                    <a
                      ...
                      className="text-2xl bg-amber-400/10 p-3 rounded-full 
                      hover:bg-amber-400/20 hover:scale-110 transition-all duration-300 relative group"
                      style={{ color }}
                    >
                      <Icon className="transition-transform group-hover:scale-125" />
                      <span className="absolute -bottom-8 left-1/2 -translate-x-1/2 
                      bg-amber-400 text-black text-xs px-2 py-1 rounded 
