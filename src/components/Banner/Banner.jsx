...
const Banner = () => {
          ...
          <div className="flex-1 space-y-8 relative md:pr-8 lg:pr-16 text-center md:text-left">
            ...
            <form onSubmit={handleSearch} className='relative max-w-2xl mx-auto md:mx-0 group'>
                ...
                shadow-2xl hover:bg-amber-400/50 transition-all duration-300'>
                    ...
                    placeholder='Discover Your next favorite food...'
  ...
  <button
    className="group flex items-center gap-3 bg-amber-800/30 hover:bg-amber-800/50
    px-6 py-3 rounded-xl transition-all duration-300 border border-amber-700/50
    hover:border-amber-400 backdrop-blur-sm focus:outline-none"
  >
    <span className="text-lg">Book Now</span>
  </button>

<button
  className="group flex items-center gap-3 bg-yellow-400 hover:bg-yellow-500
  text-[#800000] px-6 py-3 rounded-xl transition-all duration-300
  border border-yellow-500 focus:outline-none"
>
