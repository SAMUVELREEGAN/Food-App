...
export const dummyMenuData = {
  ...
  Veg: [
    {
      id: 'lunch-1',
      name: 'Paneer Caesar Salad',
      price: '199',
      rating: 4.4,
      image: ChickenCaesarSalad,
      description: 'Crisp romaine with grilled paneer, parmesan, and Caesar dressing.',
    },
    {
      id: 'lunch-2',
      name: 'Club Sandwich',
    ...
    },
    {
      ...
      description: 'Soft tortillas filled with seasoned Mushrooms, salsa, and avocado.',
    },
    {
      id: 'lunch-7',
      name: 'Sushi Combo',
    ...
    },
    {
      ...
      rating: 4.4,
      image: FishTacos,
      description: 'Grilled Potato tacos with cabbage slaw and lime crema.',
    },
  ],
  NonVeg: [
    {
